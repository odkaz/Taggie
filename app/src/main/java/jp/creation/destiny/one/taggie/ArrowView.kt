...
class ArrowView(var posX: Int, var posY: Int, var degree: Float, val createFlag: Boolean, context: Context): ImageView(context), View.OnClickListener, View.OnLongClickListener {
